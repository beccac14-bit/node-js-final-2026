...
const credit_package_purchase = require('../entities/credit_package_purchase');
...
const dataSource = new DataSource({
  ...
  entities: [ skill, creditPackage, user, coach, coach_link_skill, course, course_booking, credit_package_purchase ],
});
